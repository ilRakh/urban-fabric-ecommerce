...
export default function CarouselCardsSM({ product, title }) {
    ...
    useEffect(() => {
        ...
        setSpaceCard(element2.left - element1.left - 180);
    }, []);
    ...
    return (
            <div className="w-full flex justify-center flex-row">
                <div className="overflow-hidden text-uf-white relative w-[600px]">
                    ...
                    <div ref={sliceShow} className="flex flex-nowrap gap-[29px]">
