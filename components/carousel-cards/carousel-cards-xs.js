...
export default function CarouselCardsXS({ product, title }) {
    ...
    useEffect(() => {
        ...
        setSpaceCard(element2.left - element1.left - 150);
    }, []);
    ...
    return (
            <div className="w-full flex justify-center flex-row">
                <div className="overflow-hidden text-uf-white relative w-[320px]">
                    <div className="flex flex-row justify-between items-center w-full h-[40px]">
                        <h1 className="text-uf-white text-2xl">{title}</h1>
                        <div className="flex">
                    ...
                    <div ref={sliceShow} className="flex flex-nowrap gap-[20px]">
