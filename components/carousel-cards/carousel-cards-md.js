...
export default function CarouselCardsMD({ product, title }) {
    ...
    useEffect(() => {
        ...
        setSpaceCard(element2.left - element1.left - 210);
    }, []);
    ...
    return (
            <div className="w-full flex justify-center flex-row">
                <div className="overflow-hidden text-uf-white relative w-[700px]">
                    ...
                    <div ref={sliceShow} className="flex flex-nowrap gap-[35px]">
